...
public class Exercise2Test {
    ...
    public void testCase1() {
        ...
        assertEquals("15", ex.check(TEST_INPUT_1));
    }
    ...
    public void testCase2() {
        ...
        assertEquals("10", ex.check(TEST_INPUT_2));
    }
    ...
    public void testCase3() {
        ...
        assertEquals("11", ex.check(TEST_INPUT_3));
    }
    ...
    public void testCase4() {
        ...
        assertEquals("8", ex.check(TEST_INPUT_4));
    }
    ...
    public void testCase5() {
        ...
        assertEquals("0", ex.check(TEST_INPUT_5));
    }
